...
const enData = {
  translation: {
    SKILL_NAME: 'Octank Headlines',
    GET_FACT_MESSAGE: 'Here\'s your headline: ',
    HELP_MESSAGE: 'You can say get me the headlines, or, you can say exit... What can I help you with?',
    HELP_REPROMPT: 'What can I help you with?',
    FALLBACK_MESSAGE: 'The Octank skill can\'t help you with that.  It can help you get the Octank Headlines if you say get me headlines. What can I help you with?',
    FALLBACK_REPROMPT: 'What can I help you with?',
    ERROR_MESSAGE: 'Sorry, an error occurred.',
    STOP_MESSAGE: 'Goodbye!',
    FACTS:
      [
        '<audio src = \"https://d2j2t3h3kpch63.cloudfront.net/audio/english/headline_1.mp3\" />',
      ],
  },
};
...
const enauData = {
  translation: {
    SKILL_NAME: 'Australian headlines',
  },
};

const encaData = {
  translation: {
    SKILL_NAME: 'Canadian headlines',
  },
};

const engbData = {
  translation: {
    SKILL_NAME: 'British headlines',
  },
};

const eninData = {
  translation: {
    SKILL_NAME: 'Indian headlines',
  },
};

const enusData = {
  translation: {
    SKILL_NAME: 'American headlines',
  },
};
...
const frData = {
  translation: {
    SKILL_NAME: 'Actualités d\'Octank',
    GET_FACT_MESSAGE: 'Voici votre actualité. ',
    HELP_MESSAGE: 'Vous pouvez me demander de vous donner les actualités ou bien vous pouvez me dire de quitter... Comment puis-je vous aider?',
    HELP_REPROMPT: 'Comment puis-je vous aider?',
    FALLBACK_MESSAGE: 'Le skill Octank ne peut pas vous aider avec ça. Il peut vous aider à récupérer les actualités d\'Octank si vous dites Donne-moi les actualités. Comment puis-je vous aider?',
    FALLBACK_REPROMPT: 'Comment puis-je vous aider?',
    ERROR_MESSAGE: 'Désolée, une erreur est survenue.',
    STOP_MESSAGE: 'Au revoir!',
    FACTS:
      [
        '<audio src = \"https://d2j2t3h3kpch63.cloudfront.net/audio/french/headline_1.mp3\" />',
      ],
  },
};
...
const frfrData = {
  translation: {
    SKILL_NAME: ' françaises de l\'espace',
  },
};

const frcaData = {
  translation: {
    SKILL_NAME: ' canadiennes de l\'espace',
  },
};
